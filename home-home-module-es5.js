  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage(platform, alertController, renderer, storage) {
        ...
        _createClass(HomePage, [{
          ...
          key: "minimax",
          value: function minimax(isMaximizing) {
            var alpha = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : -Infinity;
            var beta = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : Infinity;
            var result = this.winner('minimax');
            ...
            if (isMaximizing) {
              ...
              for (var x = 0; x < 3; x++) {
                for (var y = 0; y < 3; y++) {
                  if (this.data[x][y] === '') {
                    this.data[x][y] = 'O';
                    var score = this.minimax(false, alpha, beta);
                    this.data[x][y] = '';
              ...
              for (var _x = 0; _x < 3; _x++) {
                for (var _y = 0; _y < 3; _y++) {
                  if (this.data[_x][_y] === '') {
                    ...
                    var _score = this.minimax(true, alpha, beta);
          ...
          value: function winner(mode) {
            ...
            if (mode === 'minimax') {
              ...
              if (this.data[0][0] === this.data[0][1] && this.data[0][1] === this.data[0][2] && this.data[0][2] === player || this.data[1][0] === this.data[1][1] && this.data[1][1] === this.data[1][2] && this.data[1][2] === player || this.data[2][0] === this.data[2][1] && this.data[2][1] === this.data[2][2] && this.data[2][2] === player || this.data[0][0] === this.data[1][0] && this.data[1][0] === this.data[2][0] && this.data[2][0] === player || this.data[0][1] === this.data[1][1] && this.data[1][1] === this.data[2][1] && this.data[2][1] === player || this.data[0][2] === this.data[1][2] && this.data[1][2] === this.data[2][2] && this.data[2][2] === player || this.data[0][0] === this.data[1][1] && this.data[1][1] === this.data[2][2] && this.data[2][2] === player || this.data[2][0] === this.data[1][1] && this.data[1][1] === this.data[0][2] && this.data[0][2] === player) {
                return 'X';
              }
            ...
            if (init) {
              this.storage.get('theme').then(function (result) {
                if (result != null) {
                  ...
                  _this2.setTheme(false, result);
                } else {
                  _this2.setTheme(false, 'dark');
                }
              });
            } else if (set === 'dark') {
              this.renderer.setAttribute(document.body, 'color-theme', 'dark');
              this.theme = 'dark'; // noinspection JSIgnoredPromiseFromCall

              this.storage.set('theme', 'dark');
            } else if (set === 'light') {
              this.renderer.setAttribute(document.body, 'color-theme', 'light');
              this.theme = 'light'; // noinspection JSIgnoredPromiseFromCall
